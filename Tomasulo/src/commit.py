...
class Commiter(Module):
    ...
    def build(self, rob: ROB, regs: RegArray, rat: RAT):
        ...
        log("commit: can_commit={} head={} is_store={} rd={} value={}", can_commit, head, is_store_head, rob.dest[head], rob.value[head])
        ...
        with Condition(can_commit):
            ...
            log("commit: retire rob={} pc=0x{:08x} rd={} is_store={} value=0x{:08x}", head, rob.pc[head], rob.dest[head], is_store_head, rob.value[head])
