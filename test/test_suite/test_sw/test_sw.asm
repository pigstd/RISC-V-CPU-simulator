...
test_suite/test_sw/test_sw.elf:     file format elf32-littleriscv
...
00000010 <main>:
  ...
  94:	41f75793          	srai	a5,a4,0x1f
  98:	0187d793          	srli	a5,a5,0x18
  9c:	00f70733          	add	a4,a4,a5
  a0:	0ff77713          	andi	a4,a4,255
  a4:	40f707b3          	sub	a5,a4,a5
