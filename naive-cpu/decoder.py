...
def decoder_logic(inst):
    ...
    imm_zero = Bits(32)(0)
    imm = is_I.select(I_imm.zext(Bits(32)),
          is_I_star.select(I_star_imm.zext(Bits(32)),
          is_S.select(S_imm.zext(Bits(32)),
          is_B.select(B_imm.zext(Bits(32)),
          is_U.select(U_imm.zext(Bits(32)),
          is_J.select(J_imm.zext(Bits(32)), imm_zero))))))
    ...
    log("decoder: mem_read = {} , mem_write = {} , is_branch = {}", mem_read, mem_write, is_branch)
